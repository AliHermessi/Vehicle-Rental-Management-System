...
<a href="admin.php" class="back-btn">Retour à la page Admin</a>
   <div class="container">
      ...
      if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm'])) {
         ...
         header('Location: list_rejected.php'); // Refresh the page after confirming
         exit();
      }

      $query = mysqli_query($conn, "SELECT * FROM `bank` WHERE `Situation` = 'Rejected'");
      ...
      <div class="user-card" id="userCard_<?php echo $row['id']; ?>">
         <div class="user-info">
            ...
            <p>Situation: <span style="color: red; font-weight: bold; font-size: 18px;">Rejeté</span></p>
            <form method="POST" style="margin-top: 10px;">
               <input type="hidden" name="user_id" value="<?php echo $row['id']; ?>">
               <button type="submit" name="confirm" class="btn accept-btn">Confirmé</button>
            </form>
         </div>
      </div>
      <?php
